...
if SAVEPLOT: plt.savefig("Filtered_Lines.svg", format="svg")
plt.show()
...
if SAVEPLOT: plt.savefig("Pathwidth.svg", format="svg")
plt.show()
...
if SAVEPLOT: plt.savefig("Pathwidth_Calculation.svg", format="svg")
plt.show()
...
nx.draw_networkx_nodes(F, pos=pos, ax=ax, nodelist=crossroads, node_size=50, node_color='red')
nx.draw_networkx_nodes(F, pos=pos, ax=ax, node_size=5, node_color='black')
nx.draw_networkx_nodes(F, pos=pos, ax=ax, nodelist=endpoints, node_size=50, node_color='blue')
...
if SAVEPLOT: plt.savefig("Deadends.svg", format="svg")
plt.show()
