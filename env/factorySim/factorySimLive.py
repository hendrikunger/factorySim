...
from factorySim.rendering import draw_simple_paths, draw_detail_paths, draw_poly, draw_pathwidth_circles, draw_route_lines, draw_BG
...
class factorySimLive(mglw.WindowConfig):
    ...
    def __init__(self, **kwargs):
        ...
        "2",  
        "Basic" + ".ifc")
        #self.machine_dict =self.factoryCreator.load_ifc_factory(ifcpath, "IFCBUILDINGELEMENTPROXY")
    ...
    def render_cairo_to_texture(self):
        ...
        draw_BG(self.cctx, self.is_darkmode)
...
#--------------------------------------------------------------------------------------------------------------------------------
    ...
    def scale_factory(self):
        ...
        scale_x = self.window_size[0] / ( bbox[2])
        scale_y = self.window_size[1] / (bbox[3])
