...
class FactorySimEnv(gym.Env):  
    ...
    def __init__(self, env_config: EnvContext, inputfile = 'None', obs_type='image', uid=0, Loglevel=0, width = 1000, heigth = 1000, maxMF_Elements = None, outputScale = 1, objectScaling = 1.0):
        super()
        self.stepCount = 0
        self._obs_type = obs_type
        self.Loglevel = Loglevel
        self.uid = uid
        self.width = width # env_config["corridor_length"]
        self.heigth = heigth
